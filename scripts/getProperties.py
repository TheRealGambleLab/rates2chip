...
if __name__ == '__main__':
	...
	parser.add_argument('--tss_offset',type=int,default=500,help='distance from tss to mask')
	parser.add_argument('--cps_offset',type=int,default=0,help='distance from CPS to mask')
	parser.add_argument('--min_len',type=int,default=50,help='minimum window length (nt)')
	parser.add_argument('--min_time',type=int,default=5,help='minimum window time (min)')
	parser.add_argument('--min_pro',type=int,default=1,help='minimum window polymerase count')
	parser.add_argument('--max_windows',type=int,required=False,help='maximum number of windows per gene')
