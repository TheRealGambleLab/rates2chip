...
if __name__ == '__main__':
	...
	parser.add_argument('--upstream',type=int,default=500,help='distance upstream of tss')
	parser.add_argument('--downstream',type=int,default=0,help='distance downstream of tss')
